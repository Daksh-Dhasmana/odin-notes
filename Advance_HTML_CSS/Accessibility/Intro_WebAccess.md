...
- The WCAG exist in order to help create a shared standard when it comes to web accessibility. 
...
## The four principles
  ...
  - **1) Perceivable**: 
     ...
     - For example, light text on a light background could be difficult for some users with a visual impairment to perceive.
   - **2) Operable**: 
